    ...
    <div className='w-full min-h-screen bg-gray-100 flex items-center justify-center px-4 sm:px-6 py-16 antialiased'>
      ...
      >
        ...
        <motion.button
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          className=' w-full flex items-center justify-center gap-3 py-3.5 px-4 mt-3 bg-[#18181b] text-white rounded-full border-none font-medium text-sm sm:text-base hover:bg-[#27272a] shadow-md transition-all duration-200 cursor-pointer'
        >
          <div className="bg-white p-0.5 rounded-full">
